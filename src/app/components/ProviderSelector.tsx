    ...
    <div className="flex items-center h-8 bg-surface-700/40 rounded-full border border-surface-600/30">
      ...
      <div className="relative">
        <select
          ...
          className={`appearance-none bg-transparent text-surface-300 text-xs font-medium ${selectedProvider ? 'pl-1.5' : 'pl-3.5'} pr-6 h-8 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent-500/30 focus-visible:rounded-l-full cursor-pointer hover:text-surface-100 transition-colors`}
          aria-label="Provider"
        >
      ...
      <div className="relative">
        <select
          ...
          className={`appearance-none bg-transparent text-surface-400 text-xs pl-3 pr-6 h-8 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent-500/30 cursor-pointer hover:text-surface-200 disabled:opacity-40 disabled:cursor-not-allowed transition-colors ${efforts.length === 0 ? 'focus-visible:rounded-r-full' : ''}`}
        ...
        <>
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none bg-transparent text-surface-400 text-xs pl-3 pr-6 h-8 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent-500/30 focus-visible:rounded-r-full cursor-pointer hover:text-surface-200 transition-colors"
